document.addEventListener('DOMContentLoaded', () => {
	...
	const toggleForm = () => {
			...
			setTimeout(() => {
					isLogin = !isLogin;
					formTitle.textContent = isLogin ? 'Bienvenido de nuevo' : 'Crear una cuenta';
					toggleText.firstChild.textContent = isLogin ? "¿Aún no tiene cuenta? " : '¿Ya tiene una cuenta? ';
					toggleBtn.textContent = isLogin ? "Inscríbete" : "Iniciar sesión";
					submitBtn.textContent = isLogin ? "Iniciar sesión" : "Inscríbete";
