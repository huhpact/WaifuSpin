...
const autoPlayButton = document.getElementById('auto-play__button');
...
function checkAndStartAutoPlay() {
  ...
  if (gameState.gamesPlayed >= autoPlaySettings.gamesCount) {
    stopAutoPlay('Nombre maximum de jeux atteints!');
    return;
  }
...
function stopAutoPlay(reason) {
  ...
  showNotification("Le jeu automatique s'est arrêté: " + reason, 'info');
}
