...
const faqData = [
    {
        ...
        answer: "Simply click on the 'Become an Affiliate' button and follow our streamlined registration process. Our team will review your application within 24 hours, and you will receive immediate access to our affiliate dashboard upon approval."
    },
    {
    ...
    },
    {
        ...
        answer: "Our minimum payout threshold is $100 for all supported cryptocurrencies. Once this threshold is reached, your earnings are automatically processed in the next payment cycle."
    },
    {
        question: "How is the revenue share calculated?",
        answer: "The revenue share is calculated based on the net gaming revenue (NGR) generated by the players you referred. Our multi-tier system offers up to 45% revenue share, with rates increasing based on your monthly performance."
    },
    {
        question: "How do you track referrals?",
        answer: "We use advanced tracking technology with a 365-day cookie duration. All player activities are tracked in real-time via our secure affiliate dashboard, ensuring complete transparency."
    }
];
