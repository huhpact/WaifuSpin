...
function showQuestion() {
	...
	let html = `
			...
			<div class="quiz__navigation">
					${currentQuestion > 0 ? '<button onclick="previousQuestion()" class="secondary__button">Previous</button>' : ''}
					<button onclick="nextQuestion()" class="primary__button">Next</button>
			</div>
	`;
...
function showResults() {
	...
	quizContent.innerHTML = `
			<div class="quiz__results">
					...
					<div class="quiz__navigation">
							<button onclick="closeQuiz()" class="primary__button">Close</button>
							<button onclick="startChat()" class="secondary__button">Contact Support</button>
					</div>
			</div>
	`;
}
