...
const greetings = [
    `Welcome back, ${userData.username}! Ready to spin?`,
    `Hey ${userData.username}! Let's make today your lucky day!`,
    `Good to see you, ${userData.username}! The slots are hot today!`
];
...
document.querySelectorAll('.amount__buttons button').forEach(button => {
    button.addEventListener('click', () => {
        ...
        alert(`Successfully deposited $${amount}! You will be redirected to Stripe.`);
    });
});
