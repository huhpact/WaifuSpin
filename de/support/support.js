...
window.addEventListener('DOMContentLoaded', () => {
    addMessage("Hallo!!! Willkommen beim WaifuSpin-Support. Wie kann ich Ihnen heute helfen? 🎮", false);
    initFAQ();
});
    ...
    try {
        const response = await fetch(OPENAI_API_URL, {
            ...
            body: JSON.stringify({
                ...
                messages: [{
                    role: 'system',
                    content: 'You are a helpful customer support agent for WaifuSpin, a crypto casino. Be professional, friendly, and knowledgeable about cryptocurrency, gambling, and account security. Keep responses concise and helpful. Never break character and you speak german.'
                }, {
                    role: 'user',
                    content: message
                }],
